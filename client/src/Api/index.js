...
export const getallhistory=()=>API.get('/video/history')
...
export const downloadVideo = (videoData) =>  API.post("/video", videoData, {responseType: "blob" });
export const getUserDownloads = (userId) =>API.get(`/downloads/${userId}`);